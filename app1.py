from dbutils1 import MONGO_URI
from dbutils1 import db_connect
from dbutils1 import db_insert_user
from dbutils1 import db_find_all
...
def login():
    ...
    if request.method == 'POST':
        if form.username.data == 'admin' and form.password.data == 'admin':
            ...
            return render_template('tables1.html', user = registered)
